...
namespace InteractiveNotifs.HubApp.Shared.Controls
{
    public sealed class CircleImage : Control
    {
        ...
        public static readonly DependencyProperty SourceProperty = DependencyProperty.Register("Source", typeof(BitmapImage), typeof(CircleImage), new PropertyMetadata(default(BitmapImage), OnSourcePropertyChanged));
        ...
        public static readonly DependencyProperty OverlayOpacityProperty = DependencyProperty.Register("OverlayOpacity", typeof(double), typeof(CircleImage), new PropertyMetadata(0));
        ...
        public static readonly DependencyProperty StretchProperty = DependencyProperty.Register("Stretch", typeof(CircleImageStretch), typeof(CircleImage), new PropertyMetadata(CircleImageStretch.UniformToWidthOrHeight, OnStretchPropertyChanged));
